<?php include("inc/header.php"); ?>
        <main class="SDmain">
            ...
            <div class="about-body e"><p>
                    I have recreated a few classic games in JavaScript.<br>
                    You can find these and my other works in the Portfolio.
            </p></div>
            <div class="about-body f"><p>
                    I write about my life occasionally. If that interests you, it drains out of my head into my Blog.
            </p></div>
            <div class="about-body g"><p>I am currently seeking my first job in Software Development.<br><br>
